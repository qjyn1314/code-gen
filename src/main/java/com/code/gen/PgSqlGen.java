...
//    String password = "";
//    String genPath = "";
//    DataSourceConfig sourceConfig = new DataSourceConfig.Builder(url, username, password).build();
//    // 代码生成器
//    AutoGenerator mpg = new AutoGenerator(sourceConfig);
